...
export default function Banner() {
  return (
    <div className=" mx-auto flex items-center justify-between bg-[#203A80] h-[45px]">
      <div className="left mx-auto flex items-center justify-center">
      ...
      <div className="right mx-auto flex items-center">
