...
export default function Banner() {
  return (
    <div className=" mx-auto flex items-center justify-between wrap md:flex-nowrap flex-col md:flex-row bg-[#203A80] h-[170px] md:h-[55px]">
      ...
      <div className="right mx-auto flex items-center flex-col wrap p-3 md:flex-row">
